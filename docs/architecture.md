...
- `web/js/app-vba.js`: VBA project/module editor orchestration; diff calculation/rendering lives in `app-vba-diff.js`, while save/restore/run bridge calls live in `app-vba-actions.js`.

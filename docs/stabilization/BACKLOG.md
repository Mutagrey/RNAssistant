...
| 6H / 6I / 6J | Package/rename scope and ownership | 6H audit done; 6I full typed package lifecycle and R41 fix done host-neutral. Next separate 6J moves rename and removes the remaining executor-owned rename compound journal helpers. Dynamic definition authoring stays Phase 11; raw CAS stays separate from comparable text; Windows/VBE gate remains open |

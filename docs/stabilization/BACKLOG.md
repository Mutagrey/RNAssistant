...
| 6 remainder | Whole-module mutations and package scope | Next separately admitted 6E: move complete whole-module write workflow into typed domain service without mixing delete/restore/package. Then delete, restore and package/rename ownership in ordered slices; raw CAS stays separate from comparable text, package scope not reduced without consumer decision |

...
| 9A–9C / R32 | Сквозной журнал запуска и общий JSON viewer | **9A + 9B1 + diagnostics 9B2A + Agent 9B2B1 done host-neutral; следующий 9B2B2 remaining consumers.** [Требования](R32_DIAGNOSTICS_JSON_VIEWER.md), [vendor/UI evaluation](R32_VENDOR_UI_EVALUATION.md): correlated query → lossless bounded viewer → раскрываемый журнал. 9B2B2+/9B3/9C отдельны; Windows/WebView gate открыт |

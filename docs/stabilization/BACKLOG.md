...
| 10 | Финальная структурная сверка и architecture tests | **10A + 10B1 + 10B2 done host-neutral:** dependency audit; identity and VBA host helpers moved to OfficeHosts without algorithm changes; R49 fixed host-neutral. Далее два отдельных 10C invariants (application façade, затем resource projection) и 10D final check. Optional/5B2/7D consumers не трогать. [Audit](PHASE_10A_BOUNDARY_AUDIT.md), [10B1](PHASE_10B1_DOCUMENT_IDENTITY_MOVE.md), [10B2](PHASE_10B2_VBA_HOST_BACKEND_MOVE.md) |

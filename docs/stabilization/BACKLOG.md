...
| 7 | Excel read/write vertical slice | 7A scope, 7B typed reads and 7C verified `write_range` done host-neutral. Atomic 11T0/7D bound backend is the next runtime step; WQ0/WQ-EXCEL remain mandatory deferred evidence. [7B](PHASE_7B_EXCEL_READ.md), [7C](PHASE_7C_EXCEL_WRITE.md) |

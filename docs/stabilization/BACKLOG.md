...
| 10 | Финальная структурная сверка и architecture tests | **10A–10C2 done host-neutral:** dependency audit; host helpers moved to OfficeHosts; application façade moved; resource projection removed from legacy adapter; R49 fixed host-neutral. Остался отдельный 10D final audit. Optional/5B2/7D consumers не трогать. [Audit](PHASE_10A_BOUNDARY_AUDIT.md), [10B1](PHASE_10B1_DOCUMENT_IDENTITY_MOVE.md), [10B2](PHASE_10B2_VBA_HOST_BACKEND_MOVE.md), [10C1](PHASE_10C1_ASSISTANT_RUNTIME_MOVE.md), [10C2](PHASE_10C2_RESOURCE_PROJECTION_CLEANUP.md) |

...
| 9 | Persistence / UI projection | 9D1 audit, 9D2 R45 fail-stop recovery и 9D3 closed event classification/`IEventStore` done host-neutral. Next 9D4 minimal `IConversationStore`, затем 9D5 immutable `RunViewState` и stale/multi-window coverage. [9D1](PHASE_9D1_PERSISTENCE_AUDIT.md), [9D2](PHASE_9D2_RUNSTORE_RECOVERY.md), [9D3](PHASE_9D3_TYPED_EVENT_STORE.md) |

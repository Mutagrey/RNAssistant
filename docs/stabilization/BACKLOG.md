...
| 6H / 6I / 6J | Package/rename scope and ownership | 6H docs-only audit done: current session execution plus persistent install/remove/status and rename stay in stable core; dynamic definition authoring stays Phase 11. Next separate 6I moves the full package lifecycle and closes R41, then 6J moves rename and removes remaining executor-owned compound journal helpers. Raw CAS stays separate from comparable text; Windows/VBE gate remains open |

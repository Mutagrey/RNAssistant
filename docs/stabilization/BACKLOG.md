...
| 7 | Excel read/write vertical slice | 7A scope/consumers done docs-only; 7B typed reads, 7C verified write, 7D WQ0-bound backend pending. [Evidence](PHASE_7A_EXCEL_SCOPE.md) |

...
| 9 | Persistence / UI projection | 9D1 audit и 9D2 R45 fail-stop reload/reconciliation done host-neutral. Next 9D3 typed event classification/`IEventStore`, затем 9D4 `IConversationStore`, 9D5 immutable `RunViewState` и stale/multi-window coverage. [9D1](PHASE_9D1_PERSISTENCE_AUDIT.md), [9D2](PHASE_9D2_RUNSTORE_RECOVERY.md) |

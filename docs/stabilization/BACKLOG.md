...
| 10 | Финальная структурная сверка и architecture tests | **10A–10C1 done host-neutral:** dependency audit; host helpers moved to OfficeHosts; application façade moved to root Office path; R49 fixed host-neutral. Далее отдельный 10C2 resource projection cleanup и 10D final check. Optional/5B2/7D consumers не трогать. [Audit](PHASE_10A_BOUNDARY_AUDIT.md), [10B1](PHASE_10B1_DOCUMENT_IDENTITY_MOVE.md), [10B2](PHASE_10B2_VBA_HOST_BACKEND_MOVE.md), [10C1](PHASE_10C1_ASSISTANT_RUNTIME_MOVE.md) |

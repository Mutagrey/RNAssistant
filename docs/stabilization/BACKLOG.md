...
| 9A–9C / R32 | Сквозной журнал запуска и общий JSON viewer | **9A/9B1/9B2 read-only inventory, R36, 9B3 и 9B4 vendor gates done host-neutral; следующий 9C.** [Требования](R32_DIAGNOSTICS_JSON_VIEWER.md), [vendor/UI evaluation](R32_VENDOR_UI_EVALUATION.md): correlated query → lossless bounded viewer → раскрываемый журнал. Diff2Html не admitted без source-owned unified diff; Windows/WebView gate открыт |

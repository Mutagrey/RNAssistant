...
| WQ-A | In-app Qualification Center и расширяемые host packs | WQ-A0 contract и WQ-A1 host-neutral core завершены: strict manifest/catalog/coverage, finite allowlisted runner, mandatory events/CAS evidence, safe replay и typed DTO. [Contract](../qualification.md), [WQ-A1 evidence](WQ_A1_QUALIFICATION_CORE.md). Next WQ-A2: controller/UI shell над fake pack; затем WQ-A3 Excel WQ0. Никаких script execution, second store/test executor или model-owned pass |

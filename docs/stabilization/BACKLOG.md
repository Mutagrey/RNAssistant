...
| 10 | Финальная структурная сверка и architecture tests | **10A + 10B1 done host-neutral:** six dependency checks + exact inventory; host identity moved to OfficeHosts without semantic change. Далее отдельные atomic groups: 10B2 VBA host helper, 10C application façade/resource projection cleanup, 10D final docs/migration check. Optional/5B2/7D consumers не трогать. [Audit](PHASE_10A_BOUNDARY_AUDIT.md), [10B1](PHASE_10B1_DOCUMENT_IDENTITY_MOVE.md) |

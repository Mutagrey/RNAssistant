...
| 5 | Bound DocumentSession / HostRuntime | 5A: текущая access boundary выделена, 16 targeted checks pass; [ADR-0005](../decisions/ADR-0005-bound-document-session.md). 5B: bound object/runtime gate, identity/lifetime, guard-read/dispatch/read-back, manual/resource concurrency и Windows qualification; R04 открыт |

...
| 6 remainder | Delete/restore mutations and package scope | Next separately admitted 6F: move complete delete workflow without mixing restore/package. Then restore and package/rename ownership in ordered slices; raw CAS stays separate from comparable text, package scope not reduced without consumer decision |

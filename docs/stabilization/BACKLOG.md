...
| 6 remainder | Restore mutation and package scope | Next separately admitted 6G: move complete restore workflow without mixing package/rename. Then package/rename ownership in ordered slices; raw CAS stays separate from comparable text, package scope not reduced without consumer decision |

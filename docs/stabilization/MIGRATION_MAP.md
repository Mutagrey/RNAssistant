...
v2 read adapter; единственный active wire/history path всё ещё v2, switch/delete — 2C3.
...
helper имеет ближайший removal gate 2C3 выше. Dual-write не вводится.

...
governance/versioning; Phase 1A добавила только characterization tests и карту.
...
Новые compatibility adapters в Phases 0/1A не вводятся. При вводе adapter фиксировать

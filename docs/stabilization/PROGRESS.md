...
Current task: 11T9C3 is done host-neutral: all three `common.task_list_*` mutations use exact native Agent/Plan handlers and no Task List controller executor. 11T9C4 HTML workspace family is next. Real Windows/live-provider gates remain open.
...
| 11 | in progress; 11T0–11T9B + 11T9C1–11T9C3 done host-neutral, remaining native controller/authoring migration and final legacy cleanup mandatory | 11A–11D1 evidence above; [11T9C3](PHASE_11T9C3_TASK_LIST_NATIVE_RUNTIME.md) | 11T9C3: Task Lists 3/3; Plan mode 3/3; ToolPack 6/6; architecture 4/4; source inclusion 1/1; MockDemo build | not performed | 11T9C4 HTML workspace next, then capabilities/prompts, typed authoring and final generic-dispatch/adapter removal before Phase 12 |

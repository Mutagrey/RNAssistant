...
Current task: 11T9C5 is done host-neutral: capability search/read use exact native Agent/Plan handlers and the capability controller executor is gone. 11T9C6 prompt read/save is next. Real Windows/live-provider gates remain open.
...
| 11 | in progress; 11T0–11T9B + 11T9C1–11T9C5 done host-neutral, remaining native prompt/authoring migration and final legacy cleanup mandatory | 11A–11D1 evidence above; [11T9C5](PHASE_11T9C5_CAPABILITIES_NATIVE_RUNTIME.md) | 11T9C5: discovery 1/1; Skills 4/4; ToolPack 6/6; adjacent focused checks 10/10; architecture 4/4; source inclusion 1/1; MockDemo build | not performed | 11T9C6 prompts next, then typed authoring and final generic-dispatch/adapter removal before Phase 12 |
...
|---|---|---|---|
| Legacy ToolResult → LegacyToolOutcomeAdapter | ToolRuntime | Prompt/custom-authoring controller handlers → kernel records | Capabilities bypass it after 11T9C5; 11T9C6 and 11J remove the remaining consumers; R23 remains |
...
| LegacyToolResultAdapter | ToolRuntime | Prompt/custom-authoring controller executors → typed result materialization | Office/VBA/Plan/HTML/capability families bypass it after 11T9C5; 11T9C6 and 11J remove the remaining consumers; no old-history reader |

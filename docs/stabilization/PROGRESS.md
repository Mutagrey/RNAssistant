...
Current task: R63 HTML Office data-source owner-STA correction is complete host-neutral. `common.html_data_bind` and `common.html_data_refresh` now dispatch only their nested Office read through the exact bound `HostRuntime.ReadDocument`; subsequent HTML/CAS work remains outside the document gate. R61/11O1 stays complete and 11O2 remains the next tool-contract slice. Windows Excel/WebView, rebuild/error-path and live-provider gates remain open.
...
| 11 | existing-tool migration route done host-neutral through 11T10; R61 correction active with 11O1 complete | 11A–11D1 evidence above; [11J1](PHASE_11J1_TOOL_AUTHORING_NATIVE_RUNTIME.md), [11J2](PHASE_11J2_VBA_PACKAGE_NATIVE_RUNTIME.md), [11K1](PHASE_11K1_SKILL_AUTHORING_NATIVE_RUNTIME.md), [11K2](PHASE_11K2_SKILLS_UI_TYPED_BOUNDARY.md), [11T10](PHASE_11T10_ACTIVE_LEGACY_REMOVAL.md) | 11T10 full harness 589/589; 11O1 targeted Resources/Capabilities/model projection/web pass | not performed | Active legacy removed; remaining R61 family schemas/docs/test UX required before final Milestone WQ |
| 11O / R61 | in progress; 11O0–11O1 done host-neutral | [Tool Library contract](../tool-library.md#mandatory-all-tool-contract-audit-r61), [audit](R61_TOOL_CONTRACT_AUDIT.md) | 11O1 focused harness 40 distinct; web 22/22; JS syntax/source inventory pass | not performed | 11O2 Plan next; later families, UI-only built-in docs, typed Test form and Implementation/Test layout remain |

...
Current task: R61/11O2 Plan questions/doc/task-list semantic intent switch is complete host-neutral. Runtime now owns question/option, plan/artifact/revision and task-list/step identity while preserving typed pause, exact guards and verified writes. Windows Plan/Task/WebView, rebuild/error-path and live-provider gates remain open.

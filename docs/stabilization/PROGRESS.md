...
Current task: 11T9C4 is done host-neutral: all eight HTML workspace/data tools use exact native Agent handlers; the HTML controller executor and generic Office-source fallback are gone. 11T9C5 capability discovery/read is next. Real Windows/live-provider gates remain open.
...
| 11 | in progress; 11T0–11T9B + 11T9C1–11T9C4 done host-neutral, remaining native controller/authoring migration and final legacy cleanup mandatory | 11A–11D1 evidence above; [11T9C4](PHASE_11T9C4_HTML_NATIVE_RUNTIME.md) | 11T9C4: HTML 23/23; bound Word/PowerPoint/Outlook 3/3; Plan mode 3/3; ToolPack 6/6; architecture 4/4; source inclusion 1/1; MockDemo build | not performed | 11T9C5 capabilities next, then prompts, typed authoring and final generic-dispatch/adapter removal before Phase 12 |
...
|---|---|---|---|
| Legacy ToolResult → LegacyToolOutcomeAdapter | ToolRuntime | Capability/prompt/custom-authoring controller handlers → kernel records | Public VBA and HTML bypass it after 11T9C4; 11T9C5–11T9C6 and 11J remove the remaining consumers; R23 remains |
...
| LegacyToolResultAdapter | ToolRuntime | Capability/prompt/custom-authoring controller executors → typed result materialization | All Office/VBA/Plan/HTML families bypass it after 11T9C4; 11T9C5–11T9C6 and 11J remove the remaining consumers; no old-history reader |

  ...
  ["app-html-workspace-preview.js", "app-artifact-viewer-actions.js", "app-html-workspace-actions.js",
    ...
    .forEach(asset => assert.ok(index.includes(asset + "?v=" +
      (asset === "app-html-workspace-preview.js" ? "html-export-20260831-1" :
        (asset === "app-html-workspace-editor.js" ? "artifact-text-20260831-1" : "artifact-preview-20260902-1"))), asset));
  assert.ok(index.includes("app-html-workspace.js?v=artifact-preview-20260902-1"));

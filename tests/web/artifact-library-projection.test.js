...

{
  ...
  assert.ok(index.includes("app-html-workspace.js?v=artifact-preview-20260902-1"), "artifact actions have the current preview cache key");
  assert.ok(index.includes("app-html-workspace-actions.js?v=artifact-preview-20260902-1"), "artifact tool calls have the current cache key");
  assert.ok(index.includes("app-artifact-viewer-actions.js?v=artifact-preview-20260902-1"), "artifact paging owner has the current cache key");
  assert.ok(index.includes("app-html-workspace-artifacts.js?v=artifact-preview-20260902-1"), "artifact detail has the current cache key");

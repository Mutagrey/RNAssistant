...

{
  ...
  assert.ok(index.includes("app-chat-state.js?v=tool-source-20260906-1"), "chat state has the resource lifecycle cache key");
  assert.ok(index.includes("app-chat-session.js?v=tool-source-20260906-1"), "chat session has the resource lifecycle cache key");

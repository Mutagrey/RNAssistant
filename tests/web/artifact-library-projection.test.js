...

{
  ...
  assert.ok(index.includes("app-chat-state.js?v=skill-contract-20260901-1"), "chat state has the typed Skill contract cache key");
  assert.ok(index.includes("app-chat-session.js?v=skill-contract-20260901-1"), "chat session has the typed Skill contract cache key");

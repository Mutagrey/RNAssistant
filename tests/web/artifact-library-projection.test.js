...

{
  ...
  assert.ok(index.includes("app-chat-session.js?v=ui-lazy-20260903-1"), "chat session has the lazy UI cache key");
  ...
  assert.ok(index.includes("app-html-workspace.js?v=resource-export-20260905-1"), "artifact actions have the current resource export cache key");
  assert.ok(index.includes("app-html-workspace-actions.js?v=resource-export-20260905-1"), "artifact tool calls have the current resource export cache key");

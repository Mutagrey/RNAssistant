...

{
  ...
  assert.ok(index.includes("app-chat-state.js?v=skill-resource-20260906-1"), "chat state has the resource lifecycle cache key");
  assert.ok(index.includes("app-chat-session.js?v=skill-resource-20260906-1"), "chat session has the resource lifecycle cache key");
  ...
  assert.ok(index.includes("app-html-workspace.js?v=html-source-resource-20260905-1"), "artifact actions have the current resource cache key");
  assert.ok(index.includes("app-html-workspace-actions.js?v=html-source-resource-20260905-1"), "artifact tool calls have the current resource cache key");

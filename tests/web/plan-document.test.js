...

{
  ...
  assert.ok(index.includes("app-html-workspace-artifacts.js?v=artifact-preview-20260902-3"),
  ...
  ["app-html-workspace-actions.js", "app-html-workspace.js"].forEach(asset => {
    assert.ok(index.includes(asset + "?v=artifact-preview-20260902-2"), asset + " has the current preview cache key");
  });

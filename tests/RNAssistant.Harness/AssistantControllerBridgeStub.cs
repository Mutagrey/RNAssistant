...
namespace RNAssistant.Office
{
    public sealed class AssistantController
    {
        ...
        { return new ToolResultPresentationDto { ChatId = request.ChatId, RunId = request.RunId, ToolCallId = request.ToolCallId }; }
        ...
        public Task<HtmlWorkspaceSourceResponse> ReadHtmlWorkspaceSourceAsync(HtmlWorkspaceSourceRequest request, CancellationToken token) { token.ThrowIfCancellationRequested(); LastChatId = request.ChatId; return Task.FromResult(new HtmlWorkspaceSourceResponse { ChatId = request.ChatId, Resource = request.Resource }); }
        ...
        public ArtifactPdfViewerDto ReadArtifactPdfInfo(string chatId, string resourceUri)
        {
            ...
            return new ArtifactPdfViewerDto
            {
                ...
                ByteLength = 100,
                PageCount = 1,
                PageTextLengths = new List<int> { 5 },
                ExtractedTextSha256 = new string('e', 64),

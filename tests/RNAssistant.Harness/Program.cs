    ...
    internal static partial class Program
    {
        ...
        public static int Main(string[] args)
        {
            var tests = new List<HarnessTest>
            {
                ...
                Test("chat: repeated plan revises remaining work", ChatRepeatedPlanRevisesRemainingWork),
                ...
                Test("chat: multiple tool calls are replanned", MultipleToolCallsAreRejectedAndReplanned),

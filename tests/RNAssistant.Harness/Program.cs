    ...
    internal static partial class Program
    {
        ...
        public static int Main(string[] args)
        {
            var tests = new List<HarnessTest>
            {
                ...
                Test("conversation v3: v2 read adapter discards status", ConversationV2AdapterDiscardsStatus),
                Test("conversation v3: v2 read does not grant tool authority", ConversationV2AdapterDoesNotGrantToolAuthority),

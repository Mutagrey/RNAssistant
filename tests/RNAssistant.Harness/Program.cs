    ...
    internal static partial class Program
    {
        ...
        public static int Main(string[] args)
        {
            var tests = new List<HarnessTest>
            {
                ...
                Test("conversation v5: batches only explicit read-only calls", ConversationV4BatchesOnlyExplicitReadOnlyCalls),
                ...
                Test("model protocol: v5 rejects model ids and validates singleton safety", ModelProtocolValidatesV4Context),

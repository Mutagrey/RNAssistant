    ...
    internal static partial class Program
    {
        ...
        public static int Main(string[] args)
        {
            var tests = new List<HarnessTest>
            {
                ...
                new HarnessTest { Name = "planner: compatibility maps photographed legacy plan", Run = PlannerCompatibilityMapsLegacyPlanEnvelope },
                ...
                new HarnessTest { Name = "llm: separates think tags", Run = LlmThinkTagsAreSeparated },
                new HarnessTest { Name = "llm: normalizes completion formats", Run = LlmCompletionFormatsAreNormalized },
                new HarnessTest { Name = "llm: rejects malformed native arguments", Run = LlmMalformedNativeArgumentsAreRejected },
                ...
                new HarnessTest { Name = "chat: photographed legacy greeting needs no repair", Run = ChatLegacyGreetingNeedsNoRepair },

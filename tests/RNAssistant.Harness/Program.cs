    ...
    internal static partial class Program
    {
        ...
        public static int Main(string[] args)
        {
            var tests = new List<HarnessTest>
            {
                ...
                Test("settings: migrates legacy skill loading policy", SettingsMigrateLegacySkillLoadingPolicy),
                ...
                Test("vba: insert patch preserves complete lines", VbaInsertPatchPreservesCompleteLines),

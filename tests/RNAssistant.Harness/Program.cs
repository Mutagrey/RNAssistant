    ...
    internal static partial class Program
    {
        ...
        public static int Main(string[] args)
        {
            var tests = new List<HarnessTest>
            {
                ...
                Test("skill reference editor: published source and guarded save", SkillReferenceEditorReadsPublishedSource),
                Test("skill reference editor: bounded capture and lifetime", SkillReferenceEditorBoundsAndLifetime),

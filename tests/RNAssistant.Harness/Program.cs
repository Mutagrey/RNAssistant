    ...
    internal static partial class Program
    {
        ...
        public static int Main(string[] args)
        {
            var tests = new List<HarnessTest>
            {
                ...
                Test("host runtime: direct reads preserve root and target", HostRuntimeDirectReadsPreserveRootAndTarget),
                Test("host runtime: direct context reads share access", DirectContextReadsShareDocumentAccess),
                Test("host runtime: direct VBA catalog reads share access", DirectVbaCatalogReadsShareDocumentAccess),
                Test("excel identity probe: parses object identity only", ExcelIdentityProbeParsesObjectIdentity),
                Test("excel identity probe: rejects unsupported and malformed packets", ExcelIdentityProbeRejectsInvalidPackets),
                Test("excel identity probe: rejects non-Windows access", ExcelIdentityProbeRejectsNonWindowsAccess),

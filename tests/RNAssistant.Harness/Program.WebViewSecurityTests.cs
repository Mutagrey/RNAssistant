...
namespace RNAssistant.Harness
{
    internal static partial class Program
    {
        private static void WebViewSecurityRestrictsMessagesAndNavigation()
        {
            ...
            foreach (var type in new[] { "beginChatResourceUpload", "completeChatResourceUpload", "exportChatTrajectory", "getChatEventPayload", "getVbaModule", "beginVbaModuleUpload", "saveVbaModule", "createVbaModule", "readSkillSource" })
            {

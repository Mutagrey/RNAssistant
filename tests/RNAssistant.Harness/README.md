...
| Plan exact Markdown revisions, optimistic head guard, restore and append-only removal | `Program.PlanModeTests.cs`; UI payload contract in `tests/web/plan-document.test.js` | `plan document:`, `plan mode:` |

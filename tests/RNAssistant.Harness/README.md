...
| Physical/layer dependency direction | `Program.ProjectStructureTests.cs`: Core.Agent, ModelProtocol, VBA, resources, OfficeHosts and UI boundaries plus production source inclusion | `architecture:`, `harness: production projects include all source files` |

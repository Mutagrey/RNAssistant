...
| Plan exact Markdown revisions and optimistic head guard | `Program.PlanModeTests.cs`; UI payload contract in `tests/web/plan-document.test.js` | `plan document:`, `plan mode:` |

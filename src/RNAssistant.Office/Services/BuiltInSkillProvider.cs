        ...
        public static IReadOnlyList<SkillDefinition> GetSkills(IOfficeApplicationAdapter adapter)
        {
            var result = new List<SkillDefinition>
            {
                ...
                Skill(
                    ...
                    "- Copy `find` from a fresh bounded read and include enough unchanged surrounding source for exactly one case-sensitive match. Missing or ambiguous source is a stale/unsafe patch and must be re-read, never retried unchanged.\n" +

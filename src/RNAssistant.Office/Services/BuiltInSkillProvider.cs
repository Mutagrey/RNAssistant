        ...
        public static IReadOnlyList<SkillDefinition> GetSkills(IOfficeApplicationAdapter adapter)
        {
            var result = new List<SkillDefinition>
            {
                ...
                Skill(
                    ...
                    "- Call common.tools_definition_read with id only when existing implementation fields must be inspected, or without id for a compact custom-tool list. This authoring read does not load the callable schema; use common.tools_read separately before executing a tool.\n" +

    ...
    public static class OfficeToolCatalog
    {
        ...
        private static IEnumerable<ToolCatalogEntry> ExcelTools()
        {
            return new[]
            {
                ...
                Define("Excel", "excel.find_cells", "Read-only discovery: Find literal or regex matches in cell values or formulas and return cell coordinates plus bounded snippets. Do not use this tool to read all worksheet data or as an HTML data source. Read or bind a known Excel range, table, or name through common.resources_find/read and its exact semantic target.", "{\"type\":\"object\",\"properties\":{\"sheet\":{\"type\":\"string\",\"description\":\"Worksheet filter; provide it for sheet or range scope.\"},\"address\":{\"type\":\"string\",\"description\":\"A1 range; required when scope is range.\"},\"scope\":{\"type\":\"string\",\"description\":\"Search or operation scope supported by the tool.\",\"enum\":[\"workbook\",\"sheet\",\"range\",\"selection\"]},\"query\":{\"type\":\"string\",\"description\":\"Non-empty literal or regular-expression search query.\",\"minLength\":1},\"mode\":{\"type\":\"string\",\"description\":\"Text matching mode: literal or regex.\",\"default\":\"literal\",\"enum\":[\"literal\",\"regex\"]},\"matchCase\":{\"type\":\"boolean\",\"description\":\"Whether matching is case-sensitive.\",\"default\":false},\"wholeWord\":{\"type\":\"boolean\",\"description\":\"Whether only whole-word matches are accepted.\",\"default\":false},\"lookIn\":{\"type\":\"string\",\"description\":\"Cell content to inspect: values or formulas.\",\"default\":\"values\",\"enum\":[\"values\",\"formulas\",\"both\"]},\"maxResults\":{\"type\":\"integer\",\"description\":\"Maximum number of matches returned.\",\"default\":50},\"contextChars\":{\"type\":\"integer\",\"description\":\"Maximum context characters returned around each match.\",\"default\":80}},\"required\":[\"query\"],\"additionalProperties\":false}", independentLocalRead: true),

...
namespace RNAssistant.Office.Tools
{
    public static class OfficeToolCatalog
    {
        ...
        private static IEnumerable<ToolCatalogEntry> OutlookTools()
        {
            return new[]
            {
                Define("Outlook", "outlook.read_mail", "Read-only: Read message data, attachments, or both for selected/open mail or one exact EntryID.", "{\"type\":\"object\",\"properties\":{\"entryId\":{\"type\":\"string\",\"description\":\"Optional exact Outlook EntryID; omit to use selected or open mail.\"},\"content\":{\"type\":\"string\",\"enum\":[\"message\",\"attachments\",\"both\"],\"description\":\"Mail content to return.\",\"default\":\"message\"},\"maxChars\":{\"type\":\"integer\",\"description\":\"Complete-body character limit; oversized bodies fail without truncation (up to 1000000). Attachment-only reads do not read the body.\",\"default\":12000}},\"required\":[],\"additionalProperties\":false}", canSourceHtmlData: true, independentLocalRead: true),

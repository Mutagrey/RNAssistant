...
namespace RNAssistant.Office.Tools
{
    ...
    internal static class ToolDisplayCatalog
    {
            ...
            new Dictionary<string, ToolDisplayMetadata>(StringComparer.Ordinal)
        {
            ...
            { "common.resources_find", new ToolDisplayMetadata("Поиск ресурсов", "Ищу ресурсы", ToolDisplayOperation.Search) },
            { "common.resources_read", new ToolDisplayMetadata("Чтение ресурса", "Читаю ресурс", ToolDisplayOperation.Read) },

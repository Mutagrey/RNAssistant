    ...
    public static class OfficeBuiltInToolCatalog
    {
        ...
        private static IEnumerable<ToolDefinition> OutlookTools()
        {
            return new[]
            {
                ...
                Define("Outlook", "outlook.search_mail", "Read-only: Search recent mail fields with literal or regex matching and return field coordinates.", "{\"type\":\"object\",\"properties\":{\"query\":{\"type\":\"string\",\"description\":\"Non-empty literal or regular-expression search query.\",\"minLength\":1},\"mode\":{\"type\":\"string\",\"description\":\"Text matching mode: literal or regex.\",\"default\":\"literal\",\"enum\":[\"literal\",\"regex\"]},\"matchCase\":{\"type\":\"boolean\",\"description\":\"Whether matching is case-sensitive.\",\"default\":false},\"wholeWord\":{\"type\":\"boolean\",\"description\":\"Whether only whole-word matches are accepted.\",\"default\":false},\"fields\":{\"type\":\"string\",\"description\":\"Comma-separated mail fields to search: subject, sender, recipients, body.\",\"default\":\"subject,sender,body\"},\"maxItems\":{\"type\":\"integer\",\"description\":\"Maximum number of source items inspected.\",\"default\":100},\"maxResults\":{\"type\":\"integer\",\"description\":\"Maximum number of matches returned.\",\"default\":50},\"maxBodyChars\":{\"type\":\"integer\",\"description\":\"Maximum number of body characters returned per item.\",\"default\":1000},\"contextChars\":{\"type\":\"integer\",\"description\":\"Maximum context characters returned around each match.\",\"default\":80}},\"required\":[\"query\"],\"additionalProperties\":false}", independentLocalRead: true),

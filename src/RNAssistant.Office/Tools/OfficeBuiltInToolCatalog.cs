    ...
    public static class OfficeBuiltInToolCatalog
    {
        ...
        private static IEnumerable<ToolDefinition> ExcelTools()
        {
            return new[]
            {
                ...
                RunMacro("Excel", "excel.run_macro")
            };
        }
        ...
        private static IEnumerable<ToolDefinition> PowerPointTools()
        {
            return new[]
            {
                ...
                RunMacro("PowerPoint", "powerpoint.run_macro")
            };
        }
        ...
        private static ToolDefinition RunMacro(string host, string id)
        {
            return Define(
                host,
                id,
                "Mutates document and may execute arbitrary VBA code: Run any existing macro by its exact Application.Run name without a manifest or allowlist. The macro may have effects beyond the active document; use only when execution is requested and inspect the result before claiming success.",
                "{\"type\":\"object\",\"properties\":{\"macroName\":{\"type\":\"string\",\"description\":\"Exact macro name accepted by Office Application.Run, optionally qualified by document and module.\",\"minLength\":1,\"maxLength\":512},\"arguments\":{\"type\":\"array\",\"description\":\"Optional positional String, integer, number, boolean, or null arguments in declaration order.\",\"items\":{\"type\":[\"string\",\"integer\",\"number\",\"boolean\",\"null\"]},\"maxItems\":30}},\"required\":[\"macroName\"],\"additionalProperties\":false}",

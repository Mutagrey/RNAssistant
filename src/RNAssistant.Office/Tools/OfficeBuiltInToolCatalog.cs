...
namespace RNAssistant.Office.Tools
{
    public static class OfficeBuiltInToolCatalog
    {
        ...
        private static IEnumerable<ToolDefinition> WordTools()
        {
            return new[]
            {
                Define("Word", "word.get_context", "Read-only: Return active document and selection context.", "{\"type\":\"object\",\"properties\":{},\"required\":[],\"additionalProperties\":false}"),
                Define("Word", "word.read_text", "Read-only: Read document, selection, or character-range text with one source selector.", "{\"type\":\"object\",\"properties\":{\"source\":{\"type\":\"string\",\"enum\":[\"document\",\"selection\",\"range\"],\"description\":\"Text source.\",\"default\":\"document\"},\"start\":{\"type\":\"integer\",\"description\":\"Zero-based inclusive start for range source.\",\"default\":0},\"end\":{\"type\":\"integer\",\"description\":\"Zero-based exclusive end for range source.\"},\"maxChars\":{\"type\":\"integer\",\"description\":\"Maximum number of text characters returned.\",\"default\":12000}},\"required\":[],\"additionalProperties\":false}", canSourceHtmlData: true),
                ...
                Define("Word", "word.insert_page_break", "Mutates document: Insert a page break at the current cursor position.", "{\"type\":\"object\",\"properties\":{},\"required\":[],\"additionalProperties\":false}", true, true, 1),
                Define("Word", "word.add_comment", "Mutates document: Add a comment to the current selection.", "{\"type\":\"object\",\"properties\":{\"text\":{\"type\":\"string\",\"description\":\"Complete text to insert, replace, or assign.\"}},\"required\":[\"text\"],\"additionalProperties\":false}", true, true, 1)
            };
        }
        ...
        private static IEnumerable<ToolDefinition> PowerPointTools()
        {
            return new[]
            {
                Define("PowerPoint", "powerpoint.get_context", "Read-only: Return active presentation and slide context.", "{\"type\":\"object\",\"properties\":{},\"required\":[],\"additionalProperties\":false}"),
                Define("PowerPoint", "powerpoint.get_selection", "Read-only: Read selected slide or shape context.", "{\"type\":\"object\",\"properties\":{},\"required\":[],\"additionalProperties\":false}", canSourceHtmlData: true),
                ...
                Define("PowerPoint", "powerpoint.add_slide", "Mutates document: Add a text slide.", "{\"type\":\"object\",\"properties\":{\"title\":{\"type\":\"string\",\"description\":\"Human-readable title.\",\"default\":\"AI slide\"},\"body\":{\"type\":\"string\",\"description\":\"Body text for the item being created or updated.\"}},\"required\":[],\"additionalProperties\":false}", true, true, 1),
                ...
                Define("PowerPoint", "powerpoint.duplicate_slide", "Mutates document: Duplicate one slide.", "{\"type\":\"object\",\"properties\":{\"slideIndex\":{\"type\":\"integer\",\"description\":\"One-based slide index.\"}},\"required\":[\"slideIndex\"],\"additionalProperties\":false}", true, true, 1),
                Define("PowerPoint", "powerpoint.move_slide", "Mutates document: Move a slide to a new position.", "{\"type\":\"object\",\"properties\":{\"slideIndex\":{\"type\":\"integer\",\"description\":\"One-based slide index.\"},\"toIndex\":{\"type\":\"integer\",\"description\":\"One-based destination slide index.\"}},\"required\":[\"slideIndex\",\"toIndex\"],\"additionalProperties\":false}", true, true, 2, true)
            };
        }
        ...
        private static ToolDefinition HardenContract(ToolDefinition tool)
        {
            ...
            switch (tool.Id)
            {
                ...
                case "excel.read_range":
                    tool.Description = "Read-only: Read one Excel range as values or formulas, or profile it. Pass only sheet, address, and content; kind belongs to excel.inspect/write_range and is invalid here. Hard limit: 100000 cells.";
                ...
                case "excel.write_range":
                    ...
                    if (rowItems != null) rowItems["minItems"] = 1;
                    SetDiscriminatorVariants(schema, "kind",
        ...
        private static void AddCommonBounds(JObject schema)
        {
            ...
            SetBounds(properties, "maxBodyChars", 0, 1000000);

...
namespace RNAssistant.Office.Tools
{
    internal sealed class ToolAuthoringExecutor
    {
        ...
        public IEnumerable<ToolDefinition> GetControllerTools()
        {
            ...
            yield return ControllerToolDefinition.Create("common.tools_read", "Common", "Read-only: Read one custom RNAssistant tool by id, including metadata, README, pipeline, and VBA code.", "{\"type\":\"object\",\"properties\":{\"id\":{\"type\":\"string\"}},\"required\":[],\"additionalProperties\":false}");
            yield return ControllerToolDefinition.Create("common.tools_validate", "Common", "Read-only: Validate a custom RNAssistant pipeline or manifest-based VBA package without saving it.", "{\"type\":\"object\",\"properties\":{\"id\":{\"type\":\"string\"},\"host\":{\"type\":\"string\"},\"name\":{\"type\":\"string\"},\"description\":{\"type\":\"string\"},\"argumentSchemaJson\":{\"type\":\"string\"},\"executor\":{\"type\":\"string\"},\"pipelineJson\":{\"type\":\"string\"},\"code\":{\"type\":\"string\"},\"componentsJson\":{\"type\":\"string\"},\"readme\":{\"type\":\"string\"},\"enabled\":{\"type\":\"boolean\"},\"requiresConfirmation\":{\"type\":\"boolean\"},\"mutatesDocument\":{\"type\":\"boolean\"},\"mutatesLocalState\":{\"type\":\"boolean\"},\"agentCanRun\":{\"type\":\"boolean\"},\"riskLevel\":{\"type\":\"integer\"}},\"required\":[],\"additionalProperties\":false}");
            yield return ControllerToolDefinition.Create("common.tools_save", "Common", "Mutates settings: Create or update a custom RNAssistant pipeline or manifest-based VBA package.", "{\"type\":\"object\",\"properties\":{\"id\":{\"type\":\"string\"},\"host\":{\"type\":\"string\"},\"name\":{\"type\":\"string\"},\"description\":{\"type\":\"string\"},\"argumentSchemaJson\":{\"type\":\"string\"},\"executor\":{\"type\":\"string\"},\"pipelineJson\":{\"type\":\"string\"},\"code\":{\"type\":\"string\"},\"componentsJson\":{\"type\":\"string\"},\"readme\":{\"type\":\"string\"},\"enabled\":{\"type\":\"boolean\"},\"requiresConfirmation\":{\"type\":\"boolean\"},\"mutatesDocument\":{\"type\":\"boolean\"},\"mutatesLocalState\":{\"type\":\"boolean\"},\"agentCanRun\":{\"type\":\"boolean\"},\"riskLevel\":{\"type\":\"integer\"}},\"required\":[],\"additionalProperties\":false}", mutatesLocalState: true, requiresConfirmation: true, riskLevel: 1);
            yield return ControllerToolDefinition.Create("common.tools_delete", "Common", "Mutates settings: Delete a custom RNAssistant tool by id.", "{\"type\":\"object\",\"properties\":{\"id\":{\"type\":\"string\"}},\"required\":[],\"additionalProperties\":false}", mutatesLocalState: true, requiresConfirmation: true, riskLevel: 1);
        }

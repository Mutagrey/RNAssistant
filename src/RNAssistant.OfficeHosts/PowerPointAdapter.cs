    ...
    public sealed class PowerPointAdapter : IOfficeApplicationAdapter, IOfficeContextProvider, IOfficeBuiltInSkillProvider, IOfficeDocumentCatalog
    {
        ...
        public IEnumerable<ToolDefinition> GetBuiltInTools()
        {
            return new[]
            {
                ...
                Tool("powerpoint.move_slide", "Mutates document: Move a slide to a new position.", "{\"type\":\"object\",\"properties\":{\"slideIndex\":{\"type\":\"integer\"},\"toIndex\":{\"type\":\"integer\"}},\"required\":[],\"additionalProperties\":false}", true, true, 2, true),

    ...
    public sealed class OutlookAdapter : IOfficeApplicationAdapter, IOfficeContextProvider, IOfficeBuiltInSkillProvider
    {
        ...
        public IEnumerable<ToolDefinition> GetBuiltInTools()
        {
            return new[]
            {
                ...
                Tool("outlook.set_categories", "Mutates document: Set categories on selected mail.", "{\"type\":\"object\",\"properties\":{\"categories\":{\"type\":\"string\"}},\"required\":[],\"additionalProperties\":false}", true, true, 1),

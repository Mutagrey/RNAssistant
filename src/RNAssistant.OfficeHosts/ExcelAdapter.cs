    ...
    public sealed class ExcelAdapter : IOfficeApplicationAdapter, IOfficeContextProvider, IOfficeBuiltInSkillProvider, IOfficeDocumentCatalog
    {
        ...
        public IEnumerable<ToolDefinition> GetBuiltInTools()
        {
            return new[]
            {
                ...
                Tool("excel.delete_chart", "Mutates document: Delete one existing worksheet chart by name.", "{\"type\":\"object\",\"properties\":{\"sheet\":{\"type\":\"string\"},\"chartName\":{\"type\":\"string\"}},\"required\":[],\"additionalProperties\":false}", true, true, 3, true),
                ...
                Tool("excel.rename_sheet", "Mutates document: Rename a worksheet.", "{\"type\":\"object\",\"properties\":{\"sheet\":{\"type\":\"string\"},\"newName\":{\"type\":\"string\"}},\"required\":[],\"additionalProperties\":false}", true, true, 2, true),
                Tool("excel.clear_range", "Mutates document: Clear cell values, formats, or both in a range.", "{\"type\":\"object\",\"properties\":{\"sheet\":{\"type\":\"string\"},\"address\":{\"type\":\"string\"},\"clearWhat\":{\"type\":\"string\"}},\"required\":[],\"additionalProperties\":false}", true, true, 3, true),
                Tool("excel.sort_range", "Mutates document: Sort rows in a range by one key column.", "{\"type\":\"object\",\"properties\":{\"sheet\":{\"type\":\"string\"},\"address\":{\"type\":\"string\"},\"keyColumn\":{\"type\":\"integer\"},\"descending\":{\"type\":\"boolean\"},\"hasHeaders\":{\"type\":\"boolean\"}},\"required\":[],\"additionalProperties\":false}", true, true, 2, true),
                Tool("excel.filter_range", "Mutates document: Apply AutoFilter criteria to a range.", "{\"type\":\"object\",\"properties\":{\"sheet\":{\"type\":\"string\"},\"address\":{\"type\":\"string\"},\"field\":{\"type\":\"integer\"},\"criteria\":{\"type\":\"string\"}},\"required\":[],\"additionalProperties\":false}", true, true, 2, true),

...
namespace RNAssistant.Core.Models
{
    ...
    public static class AgentPromptDefaults
    {
        ...
        private const string StructuredResponseContract =
            ...
            "Ordered batches may contain independent local reads and runtime-verified managed mutations. Each call keeps its own guard, dispatch, verification and commit; the batch is not atomic and unknown mutation effects remain cumulative run evidence. Confirmation-required, external, opaque and unclassified calls must be the only call in the response. " +

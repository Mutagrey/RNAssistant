    ...
    public sealed class AgentPromptSettings
    {
        ...
        public AgentPromptSettings()
        {
            ...
            ToolRoutingPrompt =
                ...
                "When creating reusable automations, use common.tools_save for executable tools and common.skills_save for markdown guidance. When improving RNAssistant's own agent prompt templates, use common.prompts_read first and common.prompts_save only after the user asks to save the improved prompts. Validate generated pipeline/VBA tool definitions before saving.";

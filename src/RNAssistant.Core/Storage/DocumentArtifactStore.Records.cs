...
namespace RNAssistant.Core.Storage
{
    public sealed partial class DocumentArtifactStore
    {
        ...
        {
            if (artifact == null || artifact.Kind != ChatArtifactKinds.HtmlWorkspace && artifact.Kind != ChatArtifactKinds.File && artifact.Kind != ChatArtifactKinds.Markdown && artifact.Kind != SharedContextKind ||

        ...
        private static ChatMessage CreateFormatRepairMessage(string error, int attempt, int maxAttempts)
        {
            ...
            var root = new JObject
            {
                ...
                ["instruction"] =
                    ...
                    "Batch independent local reads or runtime-verified managed mutations only; calls execute sequentially; unknown mutation effects remain cumulative run evidence. Confirmation-required, external, opaque and unclassified calls must be singleton. " +

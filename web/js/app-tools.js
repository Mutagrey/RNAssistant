...
function toolLibraryComparable(tool) {
  return {
      ...
      Description: tool.Description || "",
      Display: tool.Display ? JSON.parse(JSON.stringify(tool.Display)) : null,
...
function toolLibraryMutations() {
  ...
  current.forEach(function (record) {
    ...
    mutations.push({
      ...
      display: comparable.Display || null,
...
function bindToolActions() {
  ...
  $("cloneToolButton").addEventListener("click", function () {
    ...
    state.tools.push({
      ...
      Display: source.Display ? JSON.parse(JSON.stringify(source.Display)) : null,
